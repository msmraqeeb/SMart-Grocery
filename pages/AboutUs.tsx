    ...
    <div className="bg-white min-h-screen pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-loose">
              SMart Grocery began with a simple observation: getting truly fresh, high-quality groceries in the city was harder than it should be. We started as a small local initiative connecting three organic farms with families in our neighborhood.
            </p>
            <p className="text-gray-600 leading-loose">
      ...
      <section className="container mx-auto px-4 md:px-8 pt-20">
        <div className="bg-[#004d40] rounded-[3rem] p-10 md:p-20 text-center relative overflow-hidden">
          ...
          <p className="text-emerald-100 text-lg mb-10 max-w-xl mx-auto relative z-10 opacity-80">Join thousands of families who trust SMart for their daily nutrition.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
            <button className="bg-emerald-500 hover:bg-emerald-400 text-white font-black px-10 py-5 rounded-2xl transition-all shadow-xl shadow-emerald-900/20 text-sm uppercase tracking-widest">
              Browse Products
            </button>
            <button className="bg-white/10 hover:bg-white/20 text-white font-black px-10 py-5 rounded-2xl transition-all border border-white/20 text-sm uppercase tracking-widest">
              Contact Support
            </button>
          </div>
        </div>
